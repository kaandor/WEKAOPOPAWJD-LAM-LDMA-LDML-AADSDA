...
const M3U_PATH = String.raw`C:\Users\kaandro\Downloads\CanaisBR05.m3u`;
const OUTPUT_DIR = path.resolve(__dirname, '..', '..', '..', 'WEKAOPOPAWJD-LAM-LDMA-LDML-AADSDA', 'www', 'assets', 'data');
