                ...
                <div class="section">
                    ...
                    <div class="rail">
                        ${items.map(item => {
                            ...
                            let clickAction;
                            if (isLive) {
                                clickAction = `window.location.href='./player_window.html?type=live&id=${item.id}'`;
                            } else if (isSeries) {
...
function createModal(contentHtml) {
    ...
    modal.innerHTML = `
        <div class="netflix-modal-content">
            <div class="netflix-close-btn" onclick="document.getElementById('genericModal').remove()">&times;</div>
            ...
            <div class="netflix-info-container">
                ...
                <div class="netflix-actions-stack">
                    <div style="display: flex; gap: 10px;">
                        <button class="btn-play-lg" onclick="window.location.href='./player_window.html?type=movie&id=${movie.id}'">
                    ...
                    <div style="display:flex; flex-direction:column; gap:2px;">
                        ${seasons[s].map(ep => `
                            <div class="focusable" tabindex="0" 
                                 ...
                                 onclick="window.location.href='./player_window.html?type=series&id=${id}&season=${s}&episode=${ep.episode_number || ep.episode}'">
