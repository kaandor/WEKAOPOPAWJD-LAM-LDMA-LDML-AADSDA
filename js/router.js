...
export async function mountAppShell({ currentPath }) {
  ...
  // If no local session exists and not guest, we must wait for the check
  if (!isGuest && (!session || !session.tokens || !session.tokens.accessToken)) {
        ...
        <div class="header-actions">
          <div class="profile-dropdown-container">
            ...
            <div id="profileDropdown" class="profile-dropdown hidden">
              ...
              ${isGuest ? `
              <a href="./login.html" class="dropdown-item dropdown-primary" style="color: #A855F7;">
                <span class="dropdown-icon">
                  <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l4-4m0 0l-4-4m4 4H3m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                  </svg>
                </span>
                Fazer Login
              </a>
